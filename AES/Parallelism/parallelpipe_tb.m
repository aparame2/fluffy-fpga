...
for i = 1:16
   x1t(i).time = t(i,:)';
   x1t(i).signals.values = x1(i,:)';
   x1t(i).signals.dimensions = 1;
end

for i = 1:16
   y1t(i).time = t(i,:)';
   y1t(i).signals.values = y1(i,:)';
   y1t(i).signals.dimensions = 1;
end

for i = 1:16
   x2t(i).time = t(i,:)';
   x2t(i).signals.values = x2(i,:)';
   x2t(i).signals.dimensions = 1;
end

for i = 1:16
   y2t(i).time = t(i,:)';
   y2t(i).signals.values = y2(i,:)';
   y2t(i).signals.dimensions = 1;
end
...
BlockName = 'parallel';
set_param([BlockName '/From Workspace'],'VariableName','x1t(1)')
set_param([BlockName '/From Workspace16'],'VariableName','y1t(1)')
set_param([BlockName '/From Workspace2_'],'VariableName','x2t(1)')
set_param([BlockName '/From Workspace2_16'],'VariableName','y2t(1)')

for i=1:15
    set_param([BlockName '/From Workspace' num2str(i)],'VariableName',['x1t(' num2str(i+1) ')'])
    set_param([BlockName '/From Workspace' num2str(i+16)],'VariableName',['y1t(' num2str(i+1) ')'])
     set_param([BlockName '/From Workspace2_' num2str(i)],'VariableName',['x2t(' num2str(i+1) ')'])
    set_param([BlockName '/From Workspace2_' num2str(i+16)],'VariableName',['y2t(' num2str(i+1) ')'])
end
